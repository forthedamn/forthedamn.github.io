...
/***/ function(module, exports, __webpack_require__) {
	...
	var dataPool = {
	    '白胡子': ['shouldComponentUpdate', 'componentWillReceiveProps', 'Lifecycle Methods'],
	    '黑胡子': ['shouldComponentUpdate', 'componentWillReceiveProps', 'Lifecycle Methods'],
	    '藤虎': ['shouldComponentUpdate', 'componentWillReceiveProps', 'Lifecycle Methods']
	};
	...
	var People = React.createClass({
	    ...
	    render: function render() {
	        var peopleName = this.props.name;
	        var imgStyle = {
	        ...
	        return React.createElement(
	            'div',
	            null,
	            React.createElement('img', { src: '../src/images/head.jpg', style: imgStyle }),
	            React.createElement(
	                'div',
	                { style: nameStyle },
	                peopleName
	 ...
	 * 聊天内容控件
	 */
	var TalkText = React.createClass({
	    ...
	    render: function render() {
	        var textStyle = {
	            ...
	            maxWidth: '265px',
	            backgroundColor: '#17A115',
	            color: '#fff',
	            boxShadow: '0 0 2px #eee'
	        };
	        var name = this.props.name;
	        var talkContent = dataPool[name][this.props.contentIndex];
	        return React.createElement(
	            'div',
	            null,
	            React.createElement(
	...
	var chatMixin = {
	    ...
	    componentWillMount: function componentWillMount() {
	        var _this = this;
	        debugger;
	        this.chatContent = setInterval(function () {
	            // 随机获取该人物的聊天内容
	            _this.setState({
	                contentIndex: parseInt(Math.random() * dataPool[_this.props.name]['length'])
	            });
	        }, _this.state.refreshTime);
	    },
	    componentWillUnmount: function componentWillUnmount() {
	        debugger;
	        clearInterval(this.chatContent);
	    }
	};
	 ...
	 * 左侧聊天控件
	 */
	var LeftChatItem = React.createClass({
	    displayName: 'LeftChatItem',
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(People, { name: this.props.name }),
	            React.createElement(TalkText, { name: this.props.name, contentIndex: this.state.contentIndex })
	        );
	    }
	});
	 ...
	 * 右侧聊天控件
	 */
	var RightChatItem = React.createClass({
	    displayName: 'RightChatItem',
	...
	var ChatComponent = React.createClass({
	    ...
	    shouldComponentUpdate: function shouldComponentUpdate(nextProps, nextState) {
	        return nextProps.isSubmit;
	    },
	    render: function render() {
	        var nameArray = this.props.name;
	        var chatItem = [];
	        for (var i = 0, ii = this.props.chatNum; i < ii; i++) {
	            var name = nameArray[parseInt(Math.random() * nameArray.length)];
	            var chatArray = [React.createElement(RightChatItem, { name: name, refreshTime: this.props.delayTime }), React.createElement(LeftChatItem, { name: name, refreshTime: this.props.delayTime })];
	            chatItem.push(chatArray[parseInt(Math.random() * chatArray.length)]);
	        }
	        return React.createElement(
	            'div',
	            null,
	 ...
	 * 页面主控件
	 */
	var ChatTest = React.createClass({
	    ...
	    changeDelay: function changeDelay(e) {
	    ...
	    render: function render() {
	        var name = [];
	        for (var k in dataPool) {
	            name.push(k);
	        }
	        return React.createElement(
	            'div',
	            null,
	            React.createElement(ChatComponent, { name: name,
	                chatNum: this.state.chatNum,
	                delayTime: this.state.delayTime,
	                isSubmit: this.submit }),
	            React.createElement(
	                'form',
	                ...
	                React.createElement(
	                    ...
	                    null,
	                    '人数',
	                    React.createElement('input', { onChange: this.changeNum, value: this.state.number })
	                ),
	                React.createElement(
	                    'label',
	                    null,
	                    '延迟(ms)',
	                    React.createElement('input', { onChange: this.changeDelay, value: this.state.delay })
	                ),
	                React.createElement('input', { type: 'submit', value: '确定' })
	            )
	        );
	    }
	});

	React.render(React.createElement(ChatTest, null), document.body);
